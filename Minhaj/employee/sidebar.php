<div id="sidebar-wrapper">
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <span class="glyphicon glyphicon-search" aria-hidden="true"></span><front color="#337AB7"> STATISTICS</front>
                        </li>
                        <li>
                        ...
                        <li>
                            <span class="glyphicon glyphicon-search" aria-hidden="true"></span><front color="#337AB7"> ADMINISTRATION</front>
                        </li>
                        <li>
