<?php include 'conn.php'; 
 ...
 if(isset($_SESSION['user_role'])){
    ...
    if($_SESSION['user_role']=='Teacher'){
        header('Location: teeacher/dashboard.php');
	}	
	if($_SESSION['user_role']== 'Student'){
		header('Location: students/dashboad.php') ;
	}
}
?>
<!DOCTYPE html>
...
<?php 
    if(isset($_POST['loginBtn'])){
        ...
        $s = "select * from puc_login where email='".$email."' 
        ...
        if($r=mysqli_fetch_assoc($q)){
            ...
            if($status){
               ...
               <div class="from - group" > SORRY !  your account not Approved </div><?php
